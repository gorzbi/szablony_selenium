...
/*
        ...
        Map<String,?> winnerInfo = odpowiedz.path("winners.find {it.name=='John'}"); // w winnersach find szuka, it wszędzie pola name z wartością John
        ...
        Map<String,?> maxWinnerId = odpowiedz.path("winners.max {it.winnerId}"); // wyciągnie całe info o osbie o max id ze zbioru winners
